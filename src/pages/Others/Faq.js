        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            ...
            <p className="text-base leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto">
              The most common questions in out community
            </p>
          </div>
          <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
            <div className="w-full lg:w-1/2 px-4 py-2">
              <details className="mb-4">
                ...
                <span>
                If you're interested in creating a static website or a single webpage, you should start with Web Fundamentals of HTML and CSS. To make them interactive learn JS. Research on google You will get the future paths. 
                </span>
              </details>
              <details className="mb-4">
                <summary className="font-semibold bg-gray-200 rounded-md py-2 px-4">
                ...
                <span>
                  No, currently we don't support this Feature. We are working on this. 
                </span>
              </details>
              <details className="mb-4">
                <summary className="font-semibold  bg-gray-200 rounded-md py-2 px-4">
            ...
            <div className="w-full lg:w-1/2 px-4 py-2">
              ...
              <details className="mb-4">
                ...
                <span className="px-4 py-2">
                 There is no fixed career path CS students. This is huge field. There are various sites that students can explore. One should take the field as career path in which he/she finds most interesting. 
                </span>
              </details>
            </div>
          </div>
